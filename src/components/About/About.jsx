        ...
        <section id="about-me" className="about-me-section">
            ...
            <div className="about-me-container">
                ...
                <div className="about-me-text-content">
                    <p>Me llamo <span className="highlight-color">Patri</span> y soy desarrolladora frontend con una gran pasión por entender la lógica detrás del código y por transformar ideas en experiencias digitales claras, usables y bien construidas.</p>
